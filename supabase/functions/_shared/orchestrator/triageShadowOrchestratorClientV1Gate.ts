 ...
 *
 * Does **not** apply to `comms/web.received` (dashboard web). Does **not** run matchmaker for `llmIntent === "intake"` cold
 * leads. When matchmaker confidence is ≥ 90, stage gate is **re-applied** with the resolved wedding so dispatch matches
 * known-wedding policy (CUT4–CUT8 may apply). When not resolved, intake fallback remains.
 */
