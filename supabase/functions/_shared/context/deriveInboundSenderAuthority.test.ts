...
describe("deriveInboundSenderAuthority", () => {
  ...
  it("payer when wedding_people.is_payer", () => {
    ...
    const wp: WeddingPersonRoleRow = { person_id: "p1", role_label: "Father of bride", is_payer: true };
  ...
  it("planner from role_label", () => {
    ...
    const wp: WeddingPersonRoleRow = { person_id: "p2", role_label: "Wedding planner", is_payer: false };
  ...
  it("isApprovalContact when person id listed", () => {
    ...
    const wp: WeddingPersonRoleRow = { person_id: "p5", role_label: "Bride", is_payer: false };
