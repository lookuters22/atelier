-- Learning loop: single RPC — multi-artifact write + escalation finalization (never promotes to live playbook_rules).
...
BEGIN
  ...
  -- Idempotent retry: same outcome already stored under learning_loop target
