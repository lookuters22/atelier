      ...
      {carouselItems.map((item, index) => {
        ...
        return (
          <motion.div
            ...
            className="absolute h-[300px] w-[300px] origin-center cursor-grab overflow-hidden rounded-[2rem] shadow-2xl active:cursor-grabbing md:h-[450px] md:w-[450px] transform-gpu will-change-transform"
          >
            <img src={item.image} alt={item.title} decoding="sync" loading="eager" className="absolute inset-0 h-full w-full object-cover" />
