...
export function OtherWeddingsCard() {
  return (
    <div className="rounded-2xl border border-dashed border-border bg-canvas/70 p-4 text-[13px] text-ink-muted">
      ...
      <div className="mt-3 flex flex-col gap-2 text-[13px] font-semibold text-link">
        <Link to="/wedding/santorini" className="hover:text-link-hover">Amelia & James</Link>
        <Link to="/wedding/london" className="hover:text-link-hover">Priya & Daniel</Link>
      </div>
    </div>
  );
}
